...
print(findFiles('char_rnn_classification/names_data/names/*.txt'))

all_letters = string.ascii_letters + " .,;'"
n_letters = len(all_letters)  # 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ .,;\''


def unicodeToAscii(s):
    return ''.join(
        c for c in unicodedata.normalize('NFD', s)  # Normal form D --> canonical decomposition
        if unicodedata.category(c) != 'Mn'  # Nonspacing Mark --> https://www.compart.com/en/unicode/category/Mn#UNC_CAT
...
for filename in findFiles('char_rnn_classification/names_data/names/*.txt'):
