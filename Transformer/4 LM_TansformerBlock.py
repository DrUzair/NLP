...
class TransformerBlockLM(nn.Module):
    ...
    def forward(self, in_ids, target=None):
        ...
        block_outputs = self.block(in_ids_emb)
    ...
    def prep(self, corpus):
        ...
        self.block = TransformerBlockLM.TransformerBlock(head_count=self.sa_multihead_count,
...
model = TransformerBlockLM(batch_size=32,
                           input_length=8,
                           embed_size=32,
                           sa_multihead_count=4,
                           sa_head_size=32,
