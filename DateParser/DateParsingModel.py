...
if __name__ == "__main__":
    ...
    api.add_resource(DateParser, '/getDateVal')
    app.debug = True
    app.run(debug=app, host='10.122.33.79', port=2020, use_reloader=False)